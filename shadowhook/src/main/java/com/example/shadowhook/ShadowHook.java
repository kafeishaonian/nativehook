...
public final class ShadowHook {
            ...
            for (RecordItem recordItem: recordItems) {
                switch (recordItem) {
                    ...
                    case SYM_NAME:
                        ...
                        break;
                    case SYM_ADDR:
                        itemFlags |= recordItemSymAddress;
                        break;
                    case NEW_ADDR:
                        itemFlags |= recordItemNewAddress;
                        break;
                    case BACKUP_LEN:
    ...
    private static final int recordItemSymAddress = 1 << 5;
    private static final int recordItemNewAddress = 1 << 6;
